...
# Restart yt-dlp-gui project with fresh dependencies
# This script kills all running Electron processes and clears Vite cache for a fresh restarelse
...
kill_by_pattern "electron.*yt-dlp-gui" "Electron yt-dlp-gui"
