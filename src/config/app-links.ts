...
export const buildAppLinks = (
  ...
  macos: `https://github.com/hunght/LearnifyTube/releases/download/v${version}/LearnifyTube-darwin-arm64-${version}.zip`,
  ...
  macosIntel: `https://github.com/hunght/LearnifyTube/releases/download/v${version}/LearnifyTube-darwin-x64-${version}.zip`,
