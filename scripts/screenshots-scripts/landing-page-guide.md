# LearnifyTube Landing Page Guide

This guide explains how to build the landing page for LearnifyTube using the comprehensive feature screenshots generated by our automated process.

## Overview

The landing page showcases ALL key features of LearnifyTube through high-quality screenshots that demonstrate the app's complete functionality. Our automated screenshot process captures the following comprehensive set of features:
...
You can generate screenshots using these npm commands (the script always packages the latest app build before capturing):
...
By default the screenshots are copied to `/Users/owner/source/learnify-tube/learnify-tube-web/public/screenshots/`.
You can override the destination by setting the `LANDING_PAGE_SCREENS_DIR` environment variable before running the script.
...
<section class="feature">
  ...
  <div class="feature-image">
    <img
      ...
      alt="[Feature Name] in LearnifyTube"
      loading="lazy"
    />
  </div>
</section>
...
Track your work sessions effortlessly. LearnifyTube automatically captures your activities, helping you understand where your time goes without manual input.
...
2. Run `./scripts/screenshots-scripts/generate-screenshots.sh` from the LearnifyTube app directory
