              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-amber-600 dark:text-amber-400">
                    Restart the app after granting permissions for changes to take effect.
                  </p>
                </div>
              </div>
            </div>
