 ...
 * for the app to access browser URLs using the get-windows library.
 *
...
async function testPermissions() {
  console.log("🔍 Testing macOS Permissions for the app\n");
  ...
  console.log("\n📝 Summary:");
  console.log("─────────────");
  console.log("For the app to work properly, you need:");
