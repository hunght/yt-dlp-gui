...
|-------|----------|--------|
| > 50 | 🔴 CRITICAL | Refactor immediately - extremely hard to maintain |
| 30-50 | 🟠 HIGH | Schedule refactoring soon - too complex |
| 20-30 | 🟡 MEDIUM | Consider simplification - getting complex |
| 15-20 | 🟢 LOW | Monitor - acceptable but watch for growth |
| ≤ 15 | ✅ GOOD | Maintainable |
...
1. **🟠 api/routers/utils/index.ts:733** - Cognitive: 42
2. **🟠 api/routers/playlists/index.ts:23** - Cognitive: 35  
3. **🟠 api/routers/transcripts/index.ts:102** - Cognitive: 33
...
- `sonarjs/prefer-immediate-return` - Don't use temp vars unnecessarily
...
✅ **Per-function measurement** - pinpoint exact problem areas  
✅ **Industry standard** - used by SonarQube  
✅ **Research-backed** - based on cognitive science studies  
✅ **Better refactoring targets** - identifies truly complex code
